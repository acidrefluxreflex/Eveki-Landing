...
const TriangleGrid: React.FC<TriangleProps> = ({ triangleBase, containerClass }) => {
  useEffect(() => {
    const container = document.querySelector(`.${containerClass}`) as HTMLDivElement;
    ...
    const createTriangleSet = (index: number, column: number, row: number, container: HTMLDivElement) => {
